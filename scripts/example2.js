...
d3.csv("./data/use-of-force.csv")
    ...
    .get(function (error, rows) {
        let countMap = {};
        rows.forEach(row => {
            let ymv = row.yearMonth;
            if (countMap[ymv] !== undefined) {
                let count = countMap[ymv];
                countMap[ymv] = count + 1;
            } else {
                countMap[ymv] = 1;
            }
        })
        ...
        */
        ...
        var dataset = [];
        Object.entries(countMap).forEach(dm => {
            dataset.push({
                month: dm[0],
                count: dm[1]
            })
        ...
        */
        ...
        var margin_context = { top: 320, right: 30, bottom: 20, left: 20 },
            height_context = 370 - margin_context.top - margin_context.bottom;
        ...
        */
        ...
        var context = vis.append("g")
            .attr("class", "context")
            .attr("transform", "translate(" + margin_context.left + "," + 450 + ")");
